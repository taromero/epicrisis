...
//			username = { "a${i++}@b.com" }
			variceral = true
			antibioticoProfilactico = 'ceftriaxona'
			tratamientoEndoscopico = new TratamientoEndoscopico('exclerosis', true, false, false, true)
		}
		'ProcedimientoInvasivo' {
			accesoVenoso = 'periferico'
			veda = 'terapeutica'
			vcc = 'diagnostica'
			uti = true
			otros = ['otro1', 'otro3', 'otross9']
		}
    }
}
